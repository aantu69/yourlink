				...
				<form name="chapter-form" class="chapter-form form-horizontal"  id="formID">
					<fieldset>
						<div class="form-group">
							...
							<div class="col-lg-5">
								<input type="text" placeholder="Country Name" id="country_name" class="form-control validate[required] text-input" name="country_name">
							</div>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#submit").click(function(){
			...
			var url = "<?php echo ROOT_PATH;?>v1/countries";
			var formData = new FormData($('form#formID')[0]);
			ajaxPostCallWithSuccessMsg(api_key, url, formData, 'New country has been added successfully.','country.php');	
		});
