    ...
    <div class="container">		
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">Users-Service Provider</h3>
			</div>
			<div class="panel-body">
				<div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
					<div class="pull-left" >
						<a href="add-user-service-provider.php"><button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New User</button></a>
					</div>
				</div>
					...
					<table class="table table-striped table-hover table-bordered user">
						...
						for($i=0; $i<count($response['users']); $i++) {?>
							<tr user_id="<?php echo $response['users'][$i]['user_id']; ?>">
								<td><?php echo $response['users'][$i]['organisation_name']; ?></td>
								...
								<td><?php echo $response['users'][$i]['primary_contact']; ?></td>
								<td>
									<a href="edit-user-service-provider.php?user_id=<?php echo $response['users'][$i]["user_id"]; ?>">
