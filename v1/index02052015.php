 ...
 */
	...
	*/
	...
	/**
  * Creating new feedback category in db
  * method POST
  * params - user_id
  * @param - description
  * url - /addFeedbackCategory/
  */
  ...
  */
	...
	{
		// check for required params
		verifyRequiredParams(array('user_id','description'));
		$request = \Slim\Slim::getInstance()->request();
		...
		// creating new feedback
		$res = $db->createFeedback($user_id,$description);
...
function SendMessage()
	...
	function ShareMessage()
	{
		...
		$db = new DbHandler();
		$res = $db->shareMessage($message_id, $shared_by, $shared_to_ids);
