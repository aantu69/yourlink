        ...
        <form class="form-horizontal user-access" role="form" id="formID">
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-6 col-md-6 form-group-inner">
                    ...
                    <div class="col-sm-8 col-md-6">
                        <select class="postcode-select" id="postcode" name="postcode">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 form-group-inner">
                    ...
                    <div class="col-sm-8 col-md-6">
                        <select class="suburb-select" id="suburb" name="suburb">
                        	<option data="0" value="0">Select Suburb</option>
                        </select>
            ...
            <div class="form-group">                
                <div class="col-sm-10 col-md-8 col-md-offset-2 col-sm-offset-2">
            ...
            <div class="form-group">                
                <div class="col-sm-10 col-md-8 col-md-offset-2 col-sm-offset-2">
                    <div class="well well-lg">
						...
						<label class="checkbox" for="user_role"> Our organisation is a Aged Care Residence, Nursing Home, Care Facility or Retirement Village. </label>
                        <!--<div>
                        	<input type="checkbox" id="user_role" name="user_role">
							<label class="checkbox" for="user_role"> Our organisation is a Aged Care Residence, Nursing Home, Care Facility or Retirement Village. </label>
                            <label>
                    ...
                    <select id="category" name="category">
						...
						if(count($response_category['classes'])>0){
							for($i=0; $i<count($response_category['classes']); $i++) {
								$category_id = $response_category['classes'][$i]['level_one_class_id'];
								$category_name = $response_category['classes'][$i]['level_one_class_name'];
								if($category_name != 'Relationships (Family/Friends)' && $category_name != 'Residence'){?>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-4 col-md-2 form-group-inner">                   
                    <div class="col-xs-12">
