                        ...
                        <div class="col-xs-12 col-sm-5 col-md-4 lists-left">
							...
							if($response['error'] != 1)
							{
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item list-msg-item <?php if($i==0) echo 'active'?>" data-name="<?php echo $response['sps'][$i]['organisation_name'];?>" data-id="<?php echo $response['sps'][$i]['user_id'];?>">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-8 lists-right">
                          ...
                          <?php }
                            ...
                            <form name="chapter-form" enctype="multipart/form-data" class="message-form form-horizontal" action="" method="post" id="formID">
								...
								<input type="hidden" name="receiver_id" id="receiver_id" value="<?php echo $response['sps'][0]['user_id']; ?>"/>
								<input type="hidden" name="sp_name" id="sp_name" value="<?php echo $response['sps'][0]['organisation_name']; ?>"/>
