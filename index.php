		...
		if(isset($_FILES["profile"]["name"]))
		{
			if($_FILES["profile"]["name"] != ""){
				...
				if(move_uploaded_file($thumb_tmp_name,$thumbnail_path.$thumb_name)){
					$res = $db->spRegistration($user_role, $organisation_name, $address, $country, $state, $postcode, $suburb, $primary_contact, $phone, $thumb_name, $category, $location,  $organisation_description, $email, $password);
				}
			}else{
				$res = $db->spRegistration($user_role, $organisation_name, $address, $country, $state, $postcode, $suburb, $primary_contact, $phone, $image_url, $category, $location, $organisation_description, $email, $password);
			}
	...
	function UpdateProfile() {
		...
		if(isset($_FILES["profile"]["name"]))
		{
			if($_FILES["profile"]["name"] != ""){
				...
				if(move_uploaded_file($thumb_tmp_name,$thumbnail_path.$thumb_name)){
					$res = $db->updateProfile($user_id, $organisation_name, $address, $country, $state, $postcode, $suburb, $primary_contact, $phone, $thumb_name, $category, $location, $organisation_description, $email, $password);
				}
			}else{
				$res = $db->updateProfile($user_id, $organisation_name, $address, $country, $state, $postcode, $suburb, $primary_contact, $phone, $image_url, $category, $location, $organisation_description, $email, $password);
			}
